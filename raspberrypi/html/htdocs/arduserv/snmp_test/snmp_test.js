	...
	//////////////////////////////
		simple_test_stream_param={//location.hostname
			...
			//parser: new json_stream_parser_gr(simple_test_gr),//new raw_parser_gr(message_hub),
			  parser: new snmp_parser_gr( new json_parser_gr( new snmp_test_gr('test_data_1') ) ),
