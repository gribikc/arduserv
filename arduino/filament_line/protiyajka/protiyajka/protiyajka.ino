...
attachInterrupt(clockIn,getBit,RISING);
...
void loop(){ 
if ((indexx !=0) && (millis() - previousGetMillis > Timeout) ) { //обнуление по превышению таймаута
  indexx = 0; 
  xData = 0; 
}; 

if (indexx >23) { //если слово считано полностью
  if (oData !=xData) { 
